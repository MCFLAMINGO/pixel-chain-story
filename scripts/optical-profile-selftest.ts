#!/usr/bin/env bun
/**
 * public/optical-profile.json must match typed PXP1 constants.
 */
import { readFileSync } from "node:fs";
import { join } from "node:path";
import { opticalProfileDocument, pxp1Profile } from "../src/lib/pixel/optical-profile";
import { PAY_FACE_OPTICAL_MAGIC } from "../src/lib/pixel/pay-face-optical";
