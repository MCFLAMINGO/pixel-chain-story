...
**Illuminated map:** [`DOORS.md`](./DOORS.md) · site **`/doors`**
...
| **Visible canvas**            | The site _is_ the live field — your work can light a cell the world sees       |
...
6. **Never** lead with token price; lead with _runnable_ + _no second Facebook_.
