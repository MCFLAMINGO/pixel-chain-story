...
2. **Theft** — custodian honeypots and seed phishing. Self-custody + Kindling presence.
3. **Cheating** — double-spend and invisible approvals. UTXO finality + human-bound seals.
4. **Scams** — phishing texts that authorize value. **SMS never spends.**
...
- Telco/gateway custody sold as “easy”
- Seed-phrase UX with friendlier copy as the only path
