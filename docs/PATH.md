...
8. [~] **Spatial lattice invent** — meat behind the 3D/light vision ([`SPATIAL.md`](./SPATIAL.md)): S1–S4 tip physics + Lock→lead; S5 Three.js UI sink (`test:spatial-sink`, `/spatial`). Still open: hosted public tip default; WASM/octree only if benches demand. Dream ≠ voxel mainnet claim.
