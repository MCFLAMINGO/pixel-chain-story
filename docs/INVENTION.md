...
| **World canvas**             | One public picture of humanity — people wallets + tip marks; operators light regions of one field — not mass `init` of private notebooks ([`WORLD-CANVAS.md`](./WORLD-CANVAS.md)).                          |
