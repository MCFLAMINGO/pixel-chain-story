...
| **World canvas**             | One public picture of humanity — people wallets + tip marks; `CanvasId=(networkId,genesisHash)`; tip-mark attachment planes; operators light regions of one field — not mass `init` ([`WORLD-CANVAS.md`](./WORLD-CANVAS.md)). |
